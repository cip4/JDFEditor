...
{
	private static final Log LOGGER = LogFactory.getLog(DCOutputTreeCellRenderer.class);
	...
	protected void setNodeIcon(JDFTreeNode node, JDFTreeModel model)
	{
		...
		else if (nodeName.equals("MissingSubelement") || nodeName.equals("MissingElement") || nodeName.equals("MissingResourceLink") || nodeName.equals("MissingCustomerInfo")
				|| nodeName.equals("MissingNodeInfo"))
		{
			setIcon(loadImageIcon(TreeIcon.NODE_ERR));
		}
		else if (nodeName.equals("MissingResources") || nodeName.equals("MissingElements") || nodeName.equals("InvalidResources") || nodeName.equals("UnknownResources"))
		{
			setIcon(loadImageIcon(TreeIcon.NODE_ERR));
		}
